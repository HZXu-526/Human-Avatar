...
class SMPLLayer(SMPL):
    ...
    def forward(
        ...
        **kwargs
        ...
        vertices, joints, A, T, shape_offsets, pose_offsets = lbs(betas, full_pose, self.v_template,
...
class SMPLH(SMPL):
    ...
    def create_mean_pose(self, data_struct, flat_hand_mean=False):
        ...
        body_pose_mean = torch.zeros([(self.NUM_BODY_JOINTS) * 3], # +2 because MANO use two joints
                                     dtype=self.dtype)
    ...
    def forward(
        ...
        **kwargs
        ...
        # print(self.pose_mean.shape)
        # print(global_orient.shape,body_pose.shape,left_hand_pose.shape,right_hand_pose.shape)
